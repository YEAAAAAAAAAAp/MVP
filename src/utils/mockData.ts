...
export const artistsByGenre = {
  featured: mockArtists.slice(0, 5),
  abstract: mockArtists.slice(5, 9),
  impressionism: mockArtists.slice(9, 13),
  surrealism: mockArtists.slice(13, 17),
  modernArt: [mockArtists[1], mockArtists[3], mockArtists[6], mockArtists[10]],
  popArt: [mockArtists[3], mockArtists[7], mockArtists[11], mockArtists[14]],
  minimalism: [mockArtists[2], mockArtists[8], mockArtists[12], mockArtists[15]],
  expressionism: [mockArtists[0], mockArtists[4], mockArtists[9], mockArtists[16]],
  contemporary: [mockArtists[1], mockArtists[5], mockArtists[10], mockArtists[13]]
}